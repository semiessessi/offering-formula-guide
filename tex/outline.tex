...
\nname{Osiris} is typically depicted as a mummified\index{mummy} king, with green or black skin symbolizing fertility, regeneration, and the rich life giving silt from the inundation of the \sname{Nile}. He is often shown wearing the \indexed{atef} crown, a white crown flanked by two \indexed{ostrich} \indexed{feather}s, and holding the \indexed{crook} and \indexed{flail} — emblems of kingship\index{king} and authority. His images evoke the promise of \indexed{rebirth} and the eternal cycle of \indexed{life} and \indexed{death}.
...
\nname{Hathor} is frequently shown holding a \indexed{sistrum}, a musical instrument that underscores her connection to music, dance, and joy. Another prominent symbol is the \indexed{menat} necklace, which was used in rituals to invoke her protective and nurturing qualities. \nname{Hathor}'s iconography is further enriched by her depiction as the "Lady of Turquoise," with \indexed{turquoise} stones symbolizing her protection over miners and her association with the \sname{Sinai}.
...
Festivals in \nname{Hathor}'s honour were grand events usually intended as joyous celebrations. The \indexed{Festival of Drunkenness}, for example, commemorated \nname{Hathor}'s role in saving humanity from destruction by the sun god's wrath. Legend has it that she was pacified by \nname{Ra} instructing the people to make red beer, which she mistook for blood, and in her intoxication, she became a force of benevolent protection.

\subsubsection*{Legacy}

The legacy of \nname{Hathor} endures in the rich tapestry of Egyptian mythology and art.
...
The distinctive Hathoric columns, are a recognisable feature of Egyptian architecture with many well preserved examples. These inspired modern recreations during the Egyptomania of the 18th and 19th centuries. The image of \nname{Hathor} continues to captivate and inspire.
...
\section*{Variations}
\markboth{Outline}{Variations)}
\addcontentsline{toc}{section}{Variations}
